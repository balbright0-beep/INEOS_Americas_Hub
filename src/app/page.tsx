const tools = [
  {
    ...
    href: "https://ineos-allocation-app.onrender.com",
    icon: (
  ...
  },
  {
    ...
    href: "https://ineos-incentive-app.onrender.com",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    href: "https://ineos-americas-platform.onrender.com/dashboard",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    href: "https://ineos-fleet-app.onrender.com",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
